        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <strong style="justify-items: center">Print Social</strong>
                        <a href="{{ route('home') }}" class="logo">
                            <img src="{{ asset('template/assets/images/logo-foto.png') }}" width="60"
                                height="60">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Fotografías públicas</h2>
                        <span>Fotos tomadas en eventos y fuera de eventos.</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach ($imagenes as $imagen)
                                <div class="item">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ Storage::disk('s3')->url($imagen->url) }}" alt="">
                                    </div>
                        ...
                        <div class="owl-women-item owl-carousel">
                            ...
                            {{-- <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('template/assets/images/women-01.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('template/assets/images/women-02.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Classic Dress</h4>
                                    <span>$45.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('template/assets/images/women-03.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        ...
                        <div class="logo">
                            <img src="{{ asset('template/assets/images/logo-foto.png') }}" width="60" height="60"
                                alt="Print Social">
                        </div>
                        <ul>
